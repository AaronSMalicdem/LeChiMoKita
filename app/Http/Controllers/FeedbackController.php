...
// {
    ...
    // This method fetches the data from Google Sheets and returns it to the view
    // public function index()
    // {
        // Fetch the data from Google Sheets (you can change the range as needed)
//         $feedbackData = $this->googleSheetService->getSheetData('Kuwago1!A2:F'); // Assuming data starts from row 2, adjust as necessary

//         return view('feedback.index', compact('feedbackData'));
//     }
// }
...
//     return redirect()->route('feedback.index')->with('success', 'Feedback imported successfully.');
// }
