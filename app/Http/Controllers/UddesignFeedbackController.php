...
class UddesignFeedbackController extends Controller
{
    ...
    public function fetchAndStoreFeedback()
    {
        ...
        return redirect()->route('uddesignfeedback.index')->with('success', 'Feedback saved successfully!');
    }
    ...
    public function index()
    {
        ...
        return view('uddesignfeedback.index', compact('feedback', 'averageRating', 'ratingCounts'));
    }
