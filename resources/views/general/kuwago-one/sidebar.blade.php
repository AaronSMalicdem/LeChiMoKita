...
<div class="row mt-4">
    <div class="col-lg-6 sidebar"
        style="height: 300px; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(10px); width:60px; border-radius:30px; z-index:1;">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('general.kuwago-one.sales') }}"
                    class="{{ request()->routeIs('general.kuwago-one.sales') ? 'active' : '' }}" data-tooltip="Sales">
...
<style>
    .sidebar {
        ...
        /* Distribute icons evenly within the sidebar */
        padding: 5px 0;
        /* Add consistent padding to the top and bottom */
    }
    ...
    .sidebar .nav-item a.active {
        ...
        /* Circle shape */
        width: 40px;
        /* Adjust width for proper centering */
        height: 40px;
        ...
        margin: 0 auto;
        /* Center the active tab horizontally within the sidebar */
    }

    .sidebar .nav-item a.active i {
        color: rgba(0, 0, 0, 0.7);
        /* Darker color for the icon on active tab */
    }
</style>
